...
parser.add_argument('--model_dir', type=str, default="best_model/DDI_model",help='Directory of the model.')
parser.add_argument('--data_dir', type=str, default='dataset/DDI')
parser.add_argument('--model', type=str, default='best_model_ddi.pt', help='Name of the model file.')

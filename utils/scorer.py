...
def score(key, prediction, verbose=False):
    ...
    prediction_lable=[label2id[p] for p in prediction]
    key_lable=[label2id[p] for p in key]
    p,r,f,s = precision_recall_fscore_support(y_pred=prediction_lable, y_true=key_lable, labels=[1,2,3,4], average="micro")
